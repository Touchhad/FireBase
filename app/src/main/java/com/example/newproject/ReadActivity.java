    ...
    private void getDataFromDB()
    {
        ValueEventListener vListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                {
                    Cat user = ds.getValue(Cat.class);
                    assert user != null;
    ...
    private void setOnClickItem()
    {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Cat user = listTemp.get(position);
                Intent i = new Intent(ReadActivity.this, ShowActivity.class);
                i.putExtra(Constant.USER_NAME,user.name);
                i.putExtra(Constant.USER_PORODA,user.poroda);
                i.putExtra(Constant.USER_SITY,user.sity);
